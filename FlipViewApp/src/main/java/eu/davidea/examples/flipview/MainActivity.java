...
public class MainActivity extends AppCompatActivity {
    ...
    enableCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
      ...
      public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        Log.d(MainActivity.class.getSimpleName(),
            isChecked ? "Layout pinned, FlipView unlocked" : "Layout auto-flip, FlipView locked");
      }
    });
  }
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if (id == R.id.action_about) {
      MessageDialog.newInstance(R.drawable.ic_info_grey600_24dp, getString(R.string.about_title),
          getString(R.string.about_body, eu.davidea.utils.Utils.getVersionName(this), eu.davidea.utils.Utils.getVersionCode(this)))
